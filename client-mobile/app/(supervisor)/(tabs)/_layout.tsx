...
const tabScreens = [
    { name: 'home', title: 'Home', icon: require('../../../assets/images/dashboard.png') },
    { name: 'reports', title: 'Reports', icon: require('../../../assets/images/reports.png') },
    { name: 'teams', title: 'Teams', icon: require('../../../assets/images/teams.png') },
    { name: 'profile', title: 'Profile', icon: require('../../../assets/images/supervisor.png') },
];
